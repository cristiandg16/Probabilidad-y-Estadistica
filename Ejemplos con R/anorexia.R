...
base <- read.csv("/home/gabina/Facultad/Probabilidad y Estadísitca/anorexia.data",sep="\t")
...
#frecuencia relativa
hist(Edad, xlab="Edad", main="Edad de los pacientes con anorexia", breaks = 8, xlim=c(10,35), ylim=c(0,0.15), freq=FALSE)
